...
class SolicitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitation" do
    assert_difference('Solicitation.count') do
      post solicitations_url, params: { solicitation: { ends_at: @solicitation.ends_at, publisher_id: @solicitation.publisher_id, starts_at: @solicitation.starts_at } }
    end
  ...
  test "should update solicitation" do
    patch solicitation_url(@solicitation), params: { solicitation: { ends_at: @solicitation.ends_at, publisher_id: @solicitation.publisher_id, starts_at: @solicitation.starts_at } }
